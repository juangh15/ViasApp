...
class Via(var or: Interseccion, var fn: Interseccion, val velocidad: Int, val tipovia: TipoVia, val sentido: Sentido, val numero: String, val nombre: Option[String] = None, val camara: Option[CamaraFotoDeteccion] = None,val semaforo:Semaforo= new Semaforo(0,0,1000000)) extends Recta {
