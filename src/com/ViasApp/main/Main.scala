...
object Main {
  def main(args: Array[String]): Unit = {
    ...
    val Trefresh:Int = 100
    val dt:Int = 5
    val minVehiculos:Int = 5
    val maxVehiculos:Int = 5
    
    val minVelocidad:Int = 60
    val maxVelocidad:Int = 120
    
    val grafico = new Grafico()
    val g=grafico.graficarVehiculos(Array(new Carro("Hola",new Punto(333,220)), new Carro("fsd")
                                   new Camion("RNDO",new Punto(100,100)),new Moto("sdn", new Punto(25,50))
                                   ))
    ...
    //ejemplo de trazar ruta y guardarla en lista
    //GrafoVias.construir(vias)
//val z = GrafoVias.trazarRuta(niquia, viva).edges.toList
